...
export const MOCK_PROJECT_SIMILARITY: ProjectSimilarityResult[] = [
  { sha: 'a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2', sha_short: 'a1b2c3d', prev_sha: '', prev_sha_short: '', message: 'feat: UserService 최초 작성', ts_kst: '2026-05-08 09:00:00', files_changed: 3, total_files: 12, changed_size: 2400, total_size: 18000, scores: { L1: 0, L2: 0, L3: 0, L4: 0 }, raw_scores: { L1: 0, L2: 0, L3: 0, L4: 0 } },
  { sha: 'b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3', sha_short: 'b2c3d4e', prev_sha: 'a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2', prev_sha_short: 'a1b2c3d', message: 'feat: JWT 인증 추가', ts_kst: '2026-05-08 10:04:00', files_changed: 5, total_files: 15, changed_size: 3800, total_size: 21000, scores: { L1: 0.74, L2: 0.71, L3: 0.78, L4: 0.83 }, raw_scores: { L1: 0.68, L2: 0.65, L3: 0.72, L4: 0.79 } },
  { sha: 'c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4', sha_short: 'c3d4e5f', prev_sha: 'b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3', prev_sha_short: 'b2c3d4e', message: 'feat: 결제 API 연동', ts_kst: '2026-05-08 11:30:00', files_changed: 4, total_files: 17, changed_size: 2900, total_size: 23400, scores: { L1: 0.88, L2: 0.85, L3: 0.90, L4: 0.92 }, raw_scores: { L1: 0.82, L2: 0.79, L3: 0.84, L4: 0.88 } },
  { sha: 'd4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5', sha_short: 'd4e5f6a', prev_sha: 'c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4', prev_sha_short: 'c3d4e5f', message: 'fix: NPE 수정 및 예외 처리', ts_kst: '2026-05-08 12:40:00', files_changed: 2, total_files: 17, changed_size: 480, total_size: 23480, scores: { L1: 0.96, L2: 0.94, L3: 0.97, L4: 0.98 }, raw_scores: { L1: 0.93, L2: 0.91, L3: 0.95, L4: 0.96 } },
]
